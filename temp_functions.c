...
void print_help(void){
	printf("\nTemp statistics application. Please enter key:\n\n");
	printf("-h - manual\n\n");
	printf("-f <file_name.csv> - for load file\n\n");
	printf("-m <month_number> - specify the number of the month to display\n");
